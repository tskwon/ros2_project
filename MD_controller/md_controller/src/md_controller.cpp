...
#include "std_msgs/msg/int32_multi_array.hpp" // 엔코더 값 발행을 위해 추가
...
private:
    ...
    void timerCallback() {
        ...
        if (fgInitsetting == ON) {
            ...
            // if (current_left != prev_left_position_ || current_right != prev_right_position_) {
            // }
    ...
    rclcpp::Publisher<std_msgs::msg::Int32MultiArray>::SharedPtr encoder_pub_; // 엔코더 퍼블리셔
